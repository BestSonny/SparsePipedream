...
class Stage1(torch.nn.Module):
    def __init__(self):
        ...
        self.layer4 = ME.MinkowskiBatchNorm(256, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.layer24 = ME.MinkowskiBatchNorm(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
