...
class Stage2(torch.nn.Module):
    def __init__(self):
        ...
        self.layer4 = ME.MinkowskiConvolution(in_channels=256, out_channels=512, kernel_size=[3, 3, 3], stride=[1, 1, 1], dilation=[1, 1, 1], has_bias=False, dimension=3)
        self.layer5 = ME.MinkowskiBatchNorm(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=False)
        ...
        self.layer15 = ME.MinkowskiBatchNorm(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=False)
        ...
        self.layer31 = ME.MinkowskiLinear(in_features=4096, out_features=16, bias=True)
