...
class Stage0(torch.nn.Module):
    def __init__(self):
        ...
        self.layer2 = ME.MinkowskiConvolution(in_channels=1, out_channels=64, kernel_size=[3, 3, 3], stride=[1, 1, 1], dilation=[1, 1, 1], bias=False, dimension=3)
        ...
        self.layer5 = ME.MinkowskiConvolution(in_channels=64, out_channels=64, kernel_size=[3, 3, 3], stride=[1, 1, 1], dilation=[1, 1, 1], bias=False, dimension=3)
        ...
        self.layer9 = ME.MinkowskiConvolution(in_channels=64, out_channels=128, kernel_size=[3, 3, 3], stride=[1, 1, 1], dilation=[1, 1, 1], bias=False, dimension=3)
