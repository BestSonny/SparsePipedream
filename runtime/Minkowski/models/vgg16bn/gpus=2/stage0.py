...
class Stage0(torch.nn.Module):
    def __init__(self):
        ...
        self.layer3 = MinkowskiBatchNorm(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.layer6 = MinkowskiBatchNorm(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.layer10 = MinkowskiBatchNorm(128, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
