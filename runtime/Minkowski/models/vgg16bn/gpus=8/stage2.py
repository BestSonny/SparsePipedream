...
class Stage2(torch.nn.Module):
    def __init__(self):
        ...
        self.layer14 = ME.MinkowskiGlobalMaxPooling()
        self.layer15 = ME.MinkowskiLinear(in_features=512, out_features=4096, bias=True)
        self.layer16 = ME.MinkowskiReLU()
        self.layer17 = Dropout(p=0.5, inplace=False)
        self.layer18 = ME.MinkowskiLinear(in_features=4096, out_features=4096, bias=True)
        self.layer19 = ME.MinkowskiReLU()
        self.layer20 = Dropout(p=0.5, inplace=False)
        self.layer21 = ME.MinkowskiLinear(in_features=4096, out_features=40, bias=True)
