...
class Stage1(torch.nn.Module):
    def __init__(self):
        ...
        self.layer1 = ME.MinkowskiBatchNorm(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layer2 = ME.MinkowskiReLU()
        self.layer3 = ME.MinkowskiConvolution(in_channels=512, out_channels=512, kernel_size=[3, 3, 3], stride=[1, 1, 1], dilation=[1, 1, 1], has_bias=False, dimension=3)
        self.layer4 = ME.MinkowskiBatchNorm(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.layer14 = ME.MinkowskiBatchNorm(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.layer17 = ME.MinkowskiGlobalMaxPooling()
        self.layer18 = ME.MinkowskiLinear(in_features=512, out_features=4096, bias=True)
        self.layer19 = ME.MinkowskiReLU()
        self.layer20 = Dropout(p=0.5, inplace=False)
        self.layer21 = ME.MinkowskiLinear(in_features=4096, out_features=4096, bias=True)
        self.layer22 = ME.MinkowskiReLU()
        self.layer23 = Dropout(p=0.5, inplace=False)
        self.layer24 = ME.MinkowskiLinear(in_features=4096, out_features=40, bias=True)
